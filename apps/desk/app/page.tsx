...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* the assistant briefing — plain-English catch-up + do-this-first */}
      <Brief />
      ...
      {hero ? (
        ...
        <GuideCard
          ...
          title="Let's get some leads to work."
          body="Parcel sources distressed properties, finds the owners, and runs the numbers for you. Pull a batch and your hottest lead shows up right here."
          cta={{ note: 'Click “Find leads” in the top bar to start.' }}
        />
      )}
  ...
  return (
    <details className="rounded-2xl border border-slate-200 bg-white p-4">
      ...
      <p className="mt-3 text-xs text-slate-400">
        You earn the <Term k="assignment_fee">assignment fee</Term> — the gap
        between your contract price and what your buyer pays. Target: about one
        $10k deal a month.
      </p>
    </details>
  );
